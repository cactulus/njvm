    ...
    void convert_opcode() {
      ...
      switch (opcode) {
        ...
        case OP_IOR: {
          ...
          switch (opcode) {
            ...
            case OP_IREM:
              ...
              break;
            case OP_ISHL:
              op = Instruction::BinaryOps::AShr;
              break;
            case OP_ISHR:
              op = Instruction::BinaryOps::AShr;
              break;
            case OP_IAND:
              op = Instruction::BinaryOps::And;
              break;
            case OP_IOR:
              op = Instruction::BinaryOps::Or;
              break;
          }
        ...
        case OP_NEWARRAY: {
          ...
          switch (type) {
            case TYPE_BOOLEAN:
              type_size = make_int(1);
              break;
            case TYPE_BYTE:
              type_size = make_int(1);
              break;
            case TYPE_SHORT:
              type_size = make_int(2);
              break;
            case TYPE_INT:
              type_size = make_int(4);
              break;
            case TYPE_LONG:
              type_size = make_int(8);
              break;
            default:
